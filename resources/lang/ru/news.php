...
return [
    ...
    'notifications' => [
        'created' => [
            'subject' => 'Создана новая новость',
            'intro' => 'Опубликована новая новость: ":title".',
            'action' => 'Открыть новость',
            'outro' => 'Вы получили это письмо, потому что подписаны на уведомления о новостях.',
            'database_message' => 'Создана новая новость: ":title".',
        ],
    ],
];
