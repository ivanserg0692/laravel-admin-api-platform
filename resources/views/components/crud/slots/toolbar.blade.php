<div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
    ...
    <div
        ...
        <div class="flex items-center space-x-3 w-full md:w-auto">
            <x-secondary-button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown"
                                class="w-full md:w-auto py-2 px-4"
                                type="button">
            ...
            <x-secondary-button id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
                                class="w-full md:w-auto py-2 px-4"
                                type="button">
