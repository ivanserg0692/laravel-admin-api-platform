...
<div id="readProductModal" tabindex="-1" aria-hidden="true"
    ...
    <div data-modal-toggle="readProductModal" class="fixed inset-0 bg-gray-900/50 dark:bg-gray-900/80"></div>
    <div class="relative z-10 p-4 w-full max-w-xl max-h-full">
        <!-- Modal content -->
