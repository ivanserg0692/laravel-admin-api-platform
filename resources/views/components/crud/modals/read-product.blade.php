<x-modals.panel name="read-product" maxWidth="xl" headerClass="flex items-start justify-between mb-4 rounded-t sm:mb-5">
    <x-slot:header>
    ...
    <div class="flex justify-between items-center">
        <div class="flex items-center space-x-3 sm:space-x-4">
            <x-buttons.primary type="button" class="px-5 py-2.5">
            ...
            <x-buttons.secondary type="button" class="px-5 py-2.5">
                Preview
            </x-buttons.secondary>
        </div>
